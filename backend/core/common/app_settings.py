...
def load_app_settings() -> AppSettings:
    return AppSettings(
        app_name=os.getenv("APP_NAME", "we-events"),
        server_name=os.getenv("SERVER_NAME", "we-events"),
        web_name=os.getenv("WEB_NAME", "we-events"),
        ...
        log_file=os.getenv("LOG_FILE", "./data/logs/we-events.log"),
